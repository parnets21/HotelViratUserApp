    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.card}>
          ...
          <Text style={styles.paragraph}>Last updated: 2025-06-26</Text>
          ...
          <Text style={styles.paragraph}>
            Welcome to <Text style={styles.bold}>Hotel Virat</Text> ("Company", "we", "our", "us")!
          </Text>

          <Text style={styles.paragraph}>
            These Terms of Service ("Terms", "Terms of Service") govern your use of our website
            located at <Text style={styles.bold}>http://192.168.1.27:9000</Text> (together or
          ...
          <Text style={styles.paragraph}>
            ...
            <Text style={styles.bold}>infohotelvirat@gmail.com</Text> so we can try to find a
            solution. These Terms apply to all visitors, users and others who wish to access or use
            Service.
          </Text>

          <Text style={styles.paragraph}>
            2. <Text style={styles.bold}>Communications</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            ...
            at infohotelvirat@gmail.com.
          </Text>

          <Text style={styles.paragraph}>
            3. <Text style={styles.bold}>Purchases</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            4. <Text style={styles.bold}>Contests, Sweepstakes and Promotions</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            5. <Text style={styles.bold}>Refunds</Text>
          </Text>

          <Text style={styles.paragraph}>
            <Text style={styles.bold}>NO REFUND POLICY:</Text> All payments made for products,
            services, orders, reservations, events, and any other transactions through Hotel Virat
            are <Text style={styles.bold}>strictly non-refundable</Text>. We do not issue refunds
            for any contracts, purchases, or services under any circumstances. Please review your
            order details carefully before confirming payment as all sales are final.
          </Text>

          <Text style={styles.paragraph}>
            6. <Text style={styles.bold}>Content</Text>
          </Text>

          <Text style={styles.paragraph}>
            Content found on or through this Service are the property of Hotel Virat or used with
          ...
          <Text style={styles.paragraph}>
            7. <Text style={styles.bold}>Prohibited Uses</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            8. <Text style={styles.bold}>Analytics</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            9. <Text style={styles.bold}>No Use By Minors</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            10. <Text style={styles.bold}>Accounts</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            11. <Text style={styles.bold}>Intellectual Property</Text>
          </Text>

          <Text style={styles.paragraph}>
            Service and its original content (excluding Content provided by users), features and
            functionality are and will remain the exclusive property of Hotel Virat and its
            ...
            without the prior written consent of Hotel Virat.
          </Text>

          <Text style={styles.paragraph}>
            12. <Text style={styles.bold}>Copyright Policy</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            ...
            please submit your claim via email to infohotelvirat@gmail.com, with the subject line:
          ...
          <Text style={styles.paragraph}>
            13. <Text style={styles.bold}>DMCA Notice and Procedure for Copyright Infringement Claims</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            You can contact our Copyright Agent via email at infohotelvirat@gmail.com.
          </Text>

          <Text style={styles.paragraph}>
            14. <Text style={styles.bold}>Error Reporting and Feedback</Text>
          </Text>

          <Text style={styles.paragraph}>
            You may provide us either directly at infohotelvirat@gmail.com or via third party sites
            and tools with information and feedback concerning errors, suggestions for improvements,
          ...
          <Text style={styles.paragraph}>
            15. <Text style={styles.bold}>Links To Other Web Sites</Text>
          </Text>

          <Text style={styles.paragraph}>
            Our Service may contain links to third party web sites or services that are not owned or
            controlled by Hotel Virat.
          </Text>

          <Text style={styles.paragraph}>
            Hotel Virat has no control over, and assumes no responsibility for the content, privacy
          ...
          <Text style={styles.paragraph}>
            16. <Text style={styles.bold}>Disclaimer Of Warranty</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            17. <Text style={styles.bold}>Limitation Of Liability</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            18. <Text style={styles.bold}>Termination</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            19. <Text style={styles.bold}>Governing Law</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            20. <Text style={styles.bold}>Changes To Service</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            21. <Text style={styles.bold}>Amendments To Terms</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            22. <Text style={styles.bold}>Waiver And Severability</Text>
          </Text>
          ...
          <Text style={styles.paragraph}>
            23. <Text style={styles.bold}>Acknowledgement</Text>
          </Text>
