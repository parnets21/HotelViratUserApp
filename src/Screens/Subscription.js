...
const SubscriptionScreen = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/menu?branchId=${selectedBranch}`);
      const data = await response.json();
      setProducts(data);
    } catch (error) {
  ...
  const fetchSubscriptions = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/subscription/user/${userId}`);
      const data = await response.json();
  ...
  const createSubscription = async () => {
    ...
    try {
      const response = await fetch('http://192.168.1.27:9000/api/v1/hotel/subscription', {
        method: 'POST',
        headers: {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/subscription/${subscriptionId}/pause`, {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                },
  ...
  const resumeSubscription = async (subscriptionId) => {
    try {
      const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/subscription/${subscriptionId}/resume`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    Alert.alert(
      ...
      [
        { text: 'Keep Subscription', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/subscription/${subscriptionId}/cancel`, {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                },
