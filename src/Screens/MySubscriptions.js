...
const MySubscriptionsScreen = () => {
  ...
  const fetchSubscriptionOrders = async () => {
    ...
    try {
      ...
      const url = `http://192.168.1.27:9000/api/v1/hotel/subscription-order/user/${userId}`;
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/subscription-order/${subscriptionId}/pause`, {
                method: 'PUT',
                headers: {
  ...
  const resumeSubscription = async (subscriptionId) => {
    try {
      const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/subscription-order/${subscriptionId}/resume`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    Alert.alert(
      ...
      [
        { text: 'Keep Subscription', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              const response = await fetch(`http://192.168.1.27:9000/api/v1/hotel/subscription-order/${subscriptionId}/cancel`, {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                },
